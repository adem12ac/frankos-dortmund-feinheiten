      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-4 lg:px-8">
        <div className="lg:col-span-1">
          <div className="flex items-center gap-3">
            <img src={logoAsset.url} alt="Frankos Logo" className="h-14 w-14 rounded-full" width={56} height={56} />
            <div>
          ...
          <p className="mt-4 text-sm leading-relaxed text-white/70">
            Ihr Fachgeschäft für authentische Balkan-Spezialitäten in Dortmund. Frisch, ehrlich und mit Liebe zur Heimat.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            <li><Link to="/" className="text-white/70 hover:text-accent">Startseite</Link></li>
            <li><Link to="/produkte" className="text-white/70 hover:text-accent">Produkte</Link></li>
            <li><Link to="/ueber-uns" className="text-white/70 hover:text-accent">Über uns</Link></li>
            <li><Link to="/kontakt" className="text-white/70 hover:text-accent">Kontakt</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-white/70">
            <li className="flex items-start gap-2">
              ...
              <span>Arnoldstraße 4<br />44147 Dortmund</span>
            </li>
            <li className="flex items-center gap-2">
              <Phone className="h-4 w-4 shrink-0 text-accent" />
              <a href="tel:+491741696161" className="hover:text-accent">+49 174 1696161</a>
            </li>
            <li className="flex items-center gap-2">
              <Mail className="h-4 w-4 shrink-0 text-accent" />
              <a href="mailto:bardhyl.saliaj@frankos-gmbh.de" className="break-all hover:text-accent">
        ...
        <div>
          <h3 className="text-sm font-semibold uppercase tracking-wider text-white">Folgen & Chatten</h3>
          ...
          <div className="mt-6 space-y-1 text-xs text-white/60">
            <p><strong className="text-white/80">Öffnungszeiten</strong></p>
